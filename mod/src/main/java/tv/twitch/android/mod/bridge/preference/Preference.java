...
public class Preference implements Comparable<Preference> {
    ...
    private int mLayoutResId = ResourcesManager.getLayoutId("preference");
    ...
    public Preference(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, ResourcesManager.getAttrId("preferenceStyle"),
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        View imageFrame = holder.findViewById(ResourcesManager.getId("icon_frame"));
        if (imageFrame == null) {
    ...
    private static class OnPreferenceCopyListener implements View.OnCreateContextMenuListener,
        ...
        public void onCreateContextMenu(ContextMenu menu, View v,
            ...
            menu.add(Menu.NONE, Menu.NONE, Menu.NONE, ResourcesManager.getString("copy"))
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            Toast.makeText(mPreference.getContext(),
                    mPreference.getContext().getString(ResourcesManager.getStringId("preference_copied"),
                            summary),
