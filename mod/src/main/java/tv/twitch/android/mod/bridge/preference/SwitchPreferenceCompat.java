...
public class SwitchPreferenceCompat extends TwoStatePreference {
    ...
    public SwitchPreferenceCompat(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, ResourcesManager.getStyleableArr("SwitchPreferenceCompatX"), defStyleAttr, defStyleRes);
    ...
    public SwitchPreferenceCompat(Context context, AttributeSet attrs) {
        this(context, attrs, ResourcesManager.getAttrId("switchPreferenceCompatStyle"));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        View switchView = holder.findViewById(ResourcesManager.getId("switchWidget"));
    ...
    private void syncViewIfAccessibilityEnabled(View view) {
        ...
        View switchView = view.findViewById(ResourcesManager.getId("switchWidget"));
        syncSwitchView(switchView);
