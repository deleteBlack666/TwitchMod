...
final class ExpandButton extends Preference {
    ...
    private void initLayout() {
        setLayoutResource(ResourcesManager.getLayoutId("expand_button"));
        setIcon(ResourcesManager.getDrawableId("ic_arrow_down_24dp"));
        setTitle(ResourcesManager.getString("expand_button_title"));
        ...
        for (Preference preference : collapsedPreferences) {
            ...
            if (!TextUtils.isEmpty(title)) {
                if (summary == null) {
                    ...
                    summary = getContext().getString(ResourcesManager.getStringId("summary_collapsed_preference_list"), summary, title);
                }
            }
        }
        setSummary(summary);
