...
public class EditTextPreference extends DialogPreference {
    ...
    public EditTextPreference(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, ResourcesManager.getStyleableArr("EditTextPreference"), defStyleAttr, defStyleRes);
    ...
    public EditTextPreference(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, ResourcesManager.getAttrId("editTextPreferenceStyle"),
    ...
    public static final class SimpleSummaryProvider implements SummaryProvider<EditTextPreference> {
        ...
        public CharSequence provideSummary(EditTextPreference preference) {
            if (TextUtils.isEmpty(preference.getText())) {
                return (preference.getContext().getString(ResourcesManager.getStringId("not_set")));
            } else {
