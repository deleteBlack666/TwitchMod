...
public class PreferenceCategory extends PreferenceGroup {
    ...
    public PreferenceCategory(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, ResourcesManager.getAttrId("preferenceCategoryStyle"),
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        if (Build.VERSION.SDK_INT >= VERSION_CODES.P) {
            ...
            final int fallbackColor = ContextCompat.getColor(getContext(), ResourcesManager.getColorId("preference_fallback_accent_color"));
