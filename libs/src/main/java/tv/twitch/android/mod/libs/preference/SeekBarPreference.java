...
public class SeekBarPreference extends Preference {
    ...
    private CharSequence mSeekBarValueSuffix;
    /**
    ...
    public SeekBarPreference(
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, ResourcesManager.getStyleableArr(context, TAG), defStyleAttr, defStyleRes);
        ...
        mAdjustable = a.getBoolean(2, true);
        mShowSeekBarValue = a.getBoolean(6, false);
        mUpdatesContinuously = a.getBoolean(7, false);
        mSeekBarValueSuffix = a.getString(5);
        a.recycle();
    }
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, ResourcesManager.getAttrId(context, "seekBarPreferenceStyle"));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        mSeekBar = (SeekBar) view.findViewById(ResourcesManager.getId(getContext(), "seekbar_fix"));
        mSeekBarValueTextView = (TextView) view.findViewById(ResourcesManager.getId(getContext(), "seekbar_value"));
    ...
    void updateLabelValue(int value) {
        if (mSeekBarValueTextView != null) {
            ...
            if (!TextUtils.isEmpty(mSeekBarValueSuffix))
                stringBuilder.append(mSeekBarValueSuffix);
            mSeekBarValueTextView.setText(stringBuilder);
        }
    }
