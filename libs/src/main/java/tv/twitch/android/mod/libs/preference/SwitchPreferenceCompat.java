...
public class SwitchPreferenceCompat extends TwoStatePreference {
    ...
    public SwitchPreferenceCompat(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, ResourcesManager.getStyleableArr(context, "SwitchPreferenceCompatX"), defStyleAttr, defStyleRes);
    ...
    public SwitchPreferenceCompat(Context context, AttributeSet attrs) {
        this(context, attrs, ResourcesManager.getAttrId(context, "switchPreferenceCompatStyle"));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        View switchView = holder.findViewById(ResourcesManager.getId(getContext(), "switchWidget"));
    ...
    private void syncViewIfAccessibilityEnabled(View view) {
        ...
        View switchView = view.findViewById(ResourcesManager.getId(getContext(), "switchWidget"));
        syncSwitchView(switchView);
