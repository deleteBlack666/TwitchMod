...
public class Preference implements Comparable<Preference> {
    ...
    public Preference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLayoutResId = ResourcesManager.getLayoutId(context, "preference");
    ...
    public Preference(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, ResourcesManager.getAttrId(context, "preferenceStyle"),
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        View imageFrame = holder.findViewById(ResourcesManager.getId(mContext, "icon_frame"));
        if (imageFrame == null) {
    ...
    private static class OnPreferenceCopyListener implements View.OnCreateContextMenuListener,
        ...
        public void onCreateContextMenu(ContextMenu menu, View v,
            ...
            menu.add(Menu.NONE, Menu.NONE, Menu.NONE, ResourcesManager.getString(mPreference.getContext(), "copy"))
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            Toast.makeText(mPreference.getContext(),
                    mPreference.getContext().getString(ResourcesManager.getStringId(mPreference.getContext(), "preference_copied"),
                            summary),
